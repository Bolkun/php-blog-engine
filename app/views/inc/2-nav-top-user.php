        ...
        <div id="collapse_share_menu" class="dropdown-menu bg-dark">
            <h4 class="h4_nav_top_user">
                <?php if (isAdminLoggedIn()) { ?>
                    <i id='edit_social_media_icon' onclick="displaySocialMediaContent()" class='fa fa-file-text'
                       aria-hidden='true'></i>
                <?php } ?>
                Social Media
            </h4>
                    ...
                    <div id="accordion">
                            ...
                            <div id="edit_social_media_content">
                                <form action="<?php echo URLROOT; ?>/index" method="post" enctype="multipart/form-data">
                                    ...
                                    <div style="color: white; padding-left: 10px;">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline text-center"
                                            ...
                                            <input id="sm_local_social_image" onclick="displaySMLocalSocialImageDiv()"
                                                   ...
                                                   value="local">
                                            <label class="custom-control-label"
                                                   for="sm_local_social_image">local</label>
                                        </div>
                                    </div>
                                    <!-- server social image -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="sm_social_image_server_div" class="custom-file">
                                            <input id="sm_social_image_server" type="text" name="sm_social_image_server"
                                                   ...
                                                   }; ?>" data-toggle="modal" data-target="#sm_social_images_list"
                                                   readonly>
                                            <span class="invalid-feedback"><?php echo $data['sm_add_image_server_err']; ?></span>
                                            <!-- Modal -->
                                            <div class="modal fade" id="sm_social_images_list" tabindex="-1"
                                                 role="dialog"
                                    ...
                                    <div class="form-group"
                                        ...
                                        <input id="submit_social_media" name="submitSocialMedia" type="submit"
                                               value="Add"
                        ...
                        <div id="social_media_data" style="<?php if (isAdminLoggedIn()) {
                            ...
                            <div class="col text-center">
                                ...
                                if ($data['sm'] !== false) {
                                    for ($i = 0; $i < count($data['sm']['id']); $i++) { ?>
                                        <a href="<?php echo $data['sm']['link'][$i]; ?>" target="_blank"
                                           style="text-decoration: none;">
                                            <img src="<?php echo PUBLIC_CORE_IMG_SOCIALURL . '/' . $data['sm']['image'][$i]; ?>"
                                                 alt="<?php echo $data['sm']['name'][$i]; ?>"
                                                 class="img-responsive sm_user_image">
                                        </a>
                                        <?php
                                    }
                                } ?>
