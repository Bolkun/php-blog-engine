        ...
        foreach ($menu['parents'][$parent] as $itemId) {
            ...
            if (!isset($menu['parents'][$itemId])) {
                ...
                if (isAdminLoggedIn()) {
                    ...
                    <i style='color: grey;' id='mmAddChild" . $menu['items'][$itemId]['blog_id'] . "' onclick='mmAddChild(" . jsonEncodeMenu($menu['items'][$itemId]['blog_id'], $menu['items'][$itemId]['title']) . ")' class='fa fa-plus mm_add_child_icon' aria-hidden='true'></i>
                    <i style='color: grey;' id='mmEditTitle" . $menu['items'][$itemId]['blog_id'] . "' onclick='mmEditTitle(" . jsonEncodeMenu($menu['items'][$itemId]['blog_id'], $menu['items'][$itemId]['title']) . ")' class='fa fa-pencil mm_edit_title_icon' aria-hidden='true'></i>
                    ...
                    <i style='color: grey;' id='mmDeleteBranch" . $menu['items'][$itemId]['blog_id'] . "' onclick='mmDeleteBranch(" . jsonEncodeMenu($menu['items'][$itemId]['blog_id'], $menu['items'][$itemId]['title']) . ")' class='fa fa-times mm_delete_branch_icon' aria-hidden='true'></i>
                    </label>
 ...
 * @param  string $blog_title   @example 'My new website'
 * @return string               @example 'My, new, website, My new website'
 */
