        ...
        foreach ($menu['parents'][$parent] as $itemId) {
            if (!isset($menu['parents'][$itemId])) {
                ...
                if(isAdminLoggedIn()){
                    ...
                    <a class='main_menu_link' href='" . URLROOT . '/' . $menu['items'][$itemId]['title'] . "'>" . $menu['items'][$itemId]['title'] . "</a>
                    ...
                    $html .= "<li><label for='subfolder2'>
                    <a class='main_menu_link' href='" . URLROOT . '/' . $menu['items'][$itemId]['title'] . "'>" . $menu['items'][$itemId]['title'] . "</a></label> 
                    <input class='main_menu_checkbox' type='checkbox' name='subfolder2'/></li>";
                }
            }
            if (isset($menu['parents'][$itemId])) {
