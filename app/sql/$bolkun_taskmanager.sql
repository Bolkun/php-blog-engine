...
create table `cost` (
  ...
  `year` 						int(4) 		not null,
  `january` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `february` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `march` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `april` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `may` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `june` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `july` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `august` 						tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `september` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `october` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `november` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  `december` 					tinyint(1) 		unsigned not null default 0 		comment 'status 0 not paid, 1 paid, 2 befreit', 
  primary key (`cost_id`)
) engine=myisam default charset=utf8;
